...
class ThemeColors {
  ...
  static ThemeColors light() {
    return ThemeColors(
      ...
      darkShade1: const Color(0xffF1F1F1),
      darkShade2: const Color(0xffE0E0E0),
      darkShade3: const Color(0xffD0D0D0),
      itemFocusColor: const Color(0xffCCCCCC),
      itemUnfocusedColor: const Color(0xffAAAAAA),
      listItemColor: const Color(0xffD0D0D0),
      listItemTextColor1: Colors.black,
      listItemTextColor2: Colors.black,
      progressIndColor1: Colors.white,
      progressIndColor2: Colors.white,
      ...
      containerShade1: Colors.white10,
      containerShade2: Colors.white38,
    );
  }
